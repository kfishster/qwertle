...
export const Modal = ({ children, close }: Props) => {
    return (
        <div className="absolute h-full w-full flex justify-center items-center" onClick={close}>
            <div onClick={stopPropagation} className="flex flex-col items-center rounded-xl md:w-2/3 w-11/12 h-5/6 md:max-h-3/4 overflow-auto px-4 bg-zinc-600/90 font-mono text-mainframe-green pb-12">
